                                ...
                                <form method='post'>
                                    <div class='row '>
                                        ...
                                        <div class='input-field col s5 m5 l2 offset-l4'>
                                            ...
                                            <input id='cantidad' type='number' name='cantidad' min='1' max='".$producto->getExistencia()."' value='<?php print(".$carrito->getCantidad().") ?>' class='validate' required>
                            ...
                            <div class='card-content'>
                                ...
                                <div class="row">
                                    ...
                                    <div class='row '>
                                        ...
                                        <div class='input-field col s12 m12 l6 offset-l4 '>
                                            <button type='submit' name='crearvaloracion' class='btn waves-effect waves-light green tooltipped' data-tooltip='Agregar Comentario'>Comentar</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class='col s12 m12 l12'>
                    <div class='card ' >
                        ...
                        foreach($comentarios as $comentarios2){
                            $date2= $comentarios2['fecha_valoracion'];
                            setlocale(LC_TIME,"es_ES");
                            $fecha1 = date_format(date_create($date2), 'l j F     Y');
                            print("
                            <!--Bloque de codigo para la forma en que se mostraran los productos-->
                            <li>
                                <div class='collapsible-header'><i class='material-icons'>people</i>$comentarios2[nombre_cliente] $comentarios2[apellido]  &nbsp;&nbsp; | &nbsp;&nbsp;&nbsp; $fecha1 &nbsp;&nbsp; |&nbsp;&nbsp;$comentarios2[valoracion]&nbsp;Estrellas</div>
