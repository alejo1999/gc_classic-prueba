...
<table class=' highlight responsive-table centered '>
	...
	foreach($data as $row){
		...
		<tr>
            ...
            <td>$row[telefono]</td>
            <td>
                <a href='update.php?id=$row[id_proveedor]' class='waves-effect waves-light'><i class='material-icons black-text'>create</i></a>
                <a href='delete.php?id=$row[id_proveedor]' id='space'onclick='borrar_producto()' class='waves-effect waves-light'href='#'><i class='material-icons red-text'>delete</i></a>
			</td>
		</tr>
		");
	}
