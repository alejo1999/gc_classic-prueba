<form autocomplete='off' method='post' enctype='multipart/form-data'>
    <div class='row'>
        ...
        <div class='input-field col s12 m3'>
          	...
          	<input id='existencia' type='number' name='existencia' class='validate' max='999.99' min='0.01' step='any' value='<?php print($producto->getExistencia()) ?>' required/>
    ...
    <div class='row right'>
        ...
        <button type='submit'  name='updater' data-tooltip='Crear' class=" waves-effect waves-light btn # 66bb6a green aligera-2 tooltipped"><i class=" material-icons">check_circle</i></button>
    </div>
</form>