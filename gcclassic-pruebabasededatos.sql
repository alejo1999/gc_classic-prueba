...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-08-2018 a las 16:11:25
...
INSERT INTO `administrador` (`id_admin`, `nombre`, `apellido`, `correo`, `contraseña`, `fecha_contraseña`, `telefono`, `id_tipousuario`) VALUES
(2, 'alejandro Ernesto', 'mejia Rodriguez', 'alejo@gmail.com', '$2y$10$jwjcY5bW77tWJ97yKvNN7OTOSUkNX6wKw695FQIKae704lNypCshG', '0000-00-00', '12345678', 1),
(3, 'dante', 'gebel', 'alox@gmail.com', '$2y$10$krb3p93oDyjDUXhZ51CByeSGxx/JhkpoSenl7rtPLv3DI0q9pOo9y', '0000-00-00', '12345678', 2),
(4, 'Carlos', 'Nuñez', 'nunez@hotmail.com', '$2y$10$jwjcY5bW77tWJ97yKvNN7OTOSUkNX6wKw695FQIKae704lNypCshG', '0000-00-00', '14253614', 1),
(6, 'Andres Oswaldo', 'Henriquez Gomez', 'andresdosmil@gmail.com', '$2y$10$58fu6BtVcnBNjljlsJ/B0.ISC528EGCiaXqSX4lf6uRUXCOWLLJYK', '0000-00-00', '22777777', 2),
(8, 'Morro', 'Morrito', 'aloxi@gmail.com', '$2y$10$sVYkC3Lk3TrJt5YTCkbYpOthZCWsg0F2..B4VC4y3RospgX/JylBu', '0000-00-00', '1', 2);
...
INSERT INTO `cliente` (`id_cliente`, `nombre_cliente`, `apellido`, `correo`, `contrasena`, `telefono`, `genero`, `estado`, `fecha_contrasena`, `fecha_bloqueo`) VALUES
(1, 'alejandro', 'mejia', 'alejo@gmail.com', '$2y$10$vbgnoKWvaqm9f5xREnxQjeD1A9WXCh22n1cnHGRTnq.XRZZxxshAO', 12345678, 0, 0, '0000-00-00', '0000-00-00'),
(2, 'jimmy ', 'rodriguez', 'jimmyguao@gmail.com', 'diostodopoderoso', 12345678, 0, 0, '0000-00-00', '0000-00-00'),
(3, 'alejandro', 'mejia', 'buenas@gmail.com', '$2y$10$PTihHuuHC5E7c0ekH35Cle.98s9S0G5QuDh8EuYwn84wKHsqMgnba', 12345678, 1, 0, '0000-00-00', '0000-00-00'),
(4, 'alejandro', 'mejia', 'drax@gmail.com', '$2y$10$jwjcY5bW77tWJ97yKvNN7OTOSUkNX6wKw695FQIKae704lNypCshG', 12457845, 0, 0, '0000-00-00', '0000-00-00'),
(5, 'daniela', 'elias', 'daniela@gmail.com', '$2y$10$ds06n4/9vhbtLo/JTE/hMeMsPWJGJiOYmlKbGkyT3mwVmd/zJ4iuS', 45124563, 1, 0, '0000-00-00', '0000-00-00'),
(7, 'Daysi', 'Ramirez', 'daysi@gmail.com', '$2y$10$q80/Gu6a0a.EwcbnZObQquU9GEhGfQGmmg0zVg0Vto7BhAT32FLHm', 8, 1, 0, '0000-00-00', '0000-00-00'),
(8, 'Alejandro', 'Mejia', 'alenetoo1999@outlook.com', '$2y$10$RacxDeFid3rj1M3EFaFfeOZ51Sh0pCTccfzr0RMo6T9ejLr92NnJG', 12345678, 0, 0, '2018-07-29', '0000-00-00'),
(9, 'gabriela', 'zelada', 'alenetoo1999@gmail.com', '$2y$10$L3MheHhTF8OyjQg3G3kUTum1dJ.soXycYrAG3erHDacQVoVlm5LYa', 78451245, 0, 0, '2018-07-27', '2018-07-28'),
(10, 'fatima', 'aguilar', 'andresdosmil@gmail.com', '$2y$10$L3MheHhTF8OyjQg3G3kUTum1dJ.soXycYrAG3erHDacQVoVlm5LYa', 12457885, 0, 0, '2018-07-30', '2018-07-28');
