...
require '../app/libraries/PHPMailer/class.smtp.php';
    try{
        ...
        if(isset($_POST['Recuperar'])){
                ...
                if($cliente->checkCorreo()){
                            ...
                            if(!$mail->send()) {                    
                                ...
                                if($cliente->setClave($pass)){
                                    if($cliente->changePassword()){
                                        ...
                                        Page::showMessage(2,"contraseña incorrecta","recuperar_contraseña.php");
                                    }
                                }
                    ...
                    Page::showMessage(2, "El correo ingresado no existe en nuestros registros." , "recuperar_contraseña.php");
                }
    ...
    require_once("../app/views/public/cuenta/recovery_password.php");
?>